...
public class DatProviderDemo3 extends TestBase {
...
//        softAssert.assertAll();
    ...
    public Object[][] getData(){
        ...
        return CVSReader.readFromCSV("src/test/resources/customers.csv");
    }


    public static void main(String[] args) {

        System.out.println(Arrays.deepToString(CVSReader.readFromCSV("src/test/resources/customers.csv")));
    }
}